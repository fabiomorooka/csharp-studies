using BasicCalculatorApp.System;
using BasicCalculatorApp.Helpers;
using BasicCalculatorApp.Validator;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Welcome to the Basic Calculator Project! \r");
